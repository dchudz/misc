...
For example, I only realized partway through this project that **the process I'm describing is discontinuous** (in the limit). Even with arbitrarily small intervals, it's a step function with (infinitely many) jumps of various sizes. That might be appropriate for some applications, but not for many. Adding a correlation structure to the jumps would be a reasonable expansion of the model. 
